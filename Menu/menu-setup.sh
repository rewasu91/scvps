...
wget -q -O /usr/local/sbin/pass-ssh "https://raw.githubusercontent.com/rewasu91/scvps/main/Menu/ssh/pass-ssh.sh"; chmod +x /usr/local/sbin/pass-ssh;
...
wget -q -O /usr/local/sbin/autobackup "https://raw.githubusercontent.com/rewasu91/scvps/main/Menu/other/autobackup.sh"; chmod +x /usr/local/sbin/autobackup;
wget -q -O /usr/local/sbin/changedns "https://raw.githubusercontent.com/rewasu91/scvps/main/Menu/other/changedns.sh"; chmod +x /usr/local/sbin/changedns;
wget -q -O /usr/local/sbin/change-port "https://raw.githubusercontent.com/rewasu91/scvps/main/Menu/other/change-port.sh"; chmod +x /usr/local/sbin/change-port;
