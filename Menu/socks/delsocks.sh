...
echo "";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "${WBBG}       [ Memadam Akaun Socks 4/5 ]          ${NC}";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "";
...
cat /etc/kaizenvpn/xray-mini-utils/socks-backup.json | jq 'del(.inbounds[0].settings.accounts[] | select(.user == "'${client}'"))' > /etc/xray-mini/socks.json;
rm -rf /etc/kaizenvpn/socks/${client};
