...
echo -e "";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "${WBBG}         [ Menu Backup & Restore ]          ${NC}";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "";
echo -e "  ${GREEN}[ 01 ]${NC} ► Tambah Email untuk Backup";
echo -e "  ${GREEN}[ 02 ]${NC} ► Backup";
echo -e "  ${GREEN}[ 03 ]${NC} ► Restore";
echo -e "  ${GREEN}[ 04 ]${NC} ► Kembali ke menu utama";
echo -e "";
echo -e "${CYAN}═══════════════════════════════════════════════════════════${NC}";
read -p "► Sila masukkan nombor pilihan anda [1-4] : " choosemu

case $choosemu in
    1) clear && addemailbackup ;;
    2) clear && backup ;;
    3) clear && restore ;;
    4) clear && menu ;;
    *)
