...
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "";
echo -e " ${CYAN}SSH & OpenVPN Tunnel${NC}";
echo -e " ${GREEN}[ 01 ]${NC} ► Membuat akaun";
echo -e " ${GREEN}[ 02 ]${NC} ► Membuat akaun percubaan";
echo -e " ${GREEN}[ 03 ]${NC} ► Mengganti password akaun";
echo -e " ${GREEN}[ 04 ]${NC} ► Senarai akaun yang sudah dibuat";
echo -e " ${GREEN}[ 05 ]${NC} ► Senarai akaun yang sedang login";
echo -e " ${GREEN}[ 06 ]${NC} ► Perbaharui akaun";
