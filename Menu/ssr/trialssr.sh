...
echo -e "";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "${WBBG}      [ Menu Percubaan ShadowsocksR ]       ${NC}";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "";
...
echo -e "";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "${WBBG}  [ Membuat Akaun Percubaan ShadowsocksR ]  ${NC}";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "";
...
# ════════════════════════════════════════
# // Maklumat Akaun Percubaan ShadowsocksR
# ════════════════════════════════════════
clear; 
echo "" | tee -a /etc/kaizenvpn/ssr/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/ssr/${Username}/config.log;
echo -e "${WBBG} [ Maklumat Akaun Percubaan ShadowsocksR ]  ${NC}" | tee -a /etc/kaizenvpn/ssr/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/ssr/${Username}/config.log;
