...
# // Getting Socks 4/5 port using grep from config
...
# ═══════════════════════════
# // Maklumat Akaun Socks 4/5
# ═══════════════════════════
clear; 
echo "" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e "${WBBG}        [ Maklumat Akaun Socks 4/5 ]        ${NC}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e " Username    ► ${Username}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e " Password    ► ${Username}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e " Dibuat Pada ► ${hariini}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e " Expire Pada ► ${exp}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e " IP          ► ${IP_NYA}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e " Address     ► ${domain}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e " Port        ► ${port}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e " SOCKS4/5 CONFIG LINK" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e " ${tmp1}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/socks/${Username}/config.log;
