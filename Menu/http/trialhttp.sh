...
echo "";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "${WBBG}    [ Membuat Akaun Percubaan HTTP ]        ${NC}";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "";
...
# ════════════════════════════════
# // Maklumat Akaun Percubaan HTTP
# ════════════════════════════════
clear; 
echo "" | tee -a /etc/kaizenvpn/http/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/http/${Username}/config.log;
echo -e "${WBBG}      [ Maklumat Akaun percubaan HTTP ]     ${NC}" | tee -a /etc/kaizenvpn/http/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/http/${Username}/config.log;
