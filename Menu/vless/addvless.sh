...
vless_xtlsd="vless://${uuid}@${domain}:${tls_port}?path=%2Fvless&security=xtls&encryption=none&type=tcp&flow=xtls-rprx-direct&sni=masukkanbugdisini#${Username}";
vless_xtlsu="vless://${uuid}@${domain}:${tls_port}?path=%2Fvless&security=xtls&encryption=none&type=tcp&flow=xtls-rprx-direct-udp443&sni=masukkanbugdisini#${Username}";
vless_xtlss="vless://${uuid}@${domain}:${tls_port}?path=%2Fvless&security=xtls&encryption=none&type=tcp&flow=xtls-rprx-splice&sni=masukkanbugdisini#${Username}";
vless_xtlssu="vless://${uuid}@${domain}:${tls_port}?path=%2Fvless&security=xtls&encryption=none&type=tcp&flow=xtls-rprx-splice-udp443&sni=masukkanbugdisini#${Username}";
...
echo -e " Port XTLS   ► ${tls_port}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " VLESS TCP XTLS DIRECT CONFIG LINK" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_xtlsd}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " VLESS TCP XTLS DIRECT UDP443 CONFIG LINK" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_xtlsu}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " VLESS TCP XTLS SPLICE CONFIG LINK" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_xtlss}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " VLESS TCP XTLS SPLICE UDP443 CONFIG LINK" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_xtlssu}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;