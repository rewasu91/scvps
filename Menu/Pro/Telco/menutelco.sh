...
echo -e "";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "${WBBG}            [ Menu Fail Telco ]             ${NC}";
echo -e "${CYAN}════════════════════════════════════════════${NC}";
echo -e "";
echo -e " ${GREEN}[ 01 ]${NC} ► Buat fail telco Digi";
echo -e " ${GREEN}[ 02 ]${NC} ► Buat fail telco Maxis";
echo -e " ${GREEN}[ 03 ]${NC} ► Buat fail telco Celcom";
