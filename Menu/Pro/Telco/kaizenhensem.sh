...
echo -e "";
echo -e "  Tunggu sekejap, saya update dulu kasi jadi menu special, minum2 kopi dulu kau bosku..";
sleep 5
echo -e "  Mau siap sudah ni..";
sleep 3
cd /usr/local/sbin
rm menu
...
cowsay -f ghostbusters "SELAMAT DATANG BOSKU.";
echo -e "";
echo -e "  OKEY SIAP SUDAH BOSKU..TIDAK PAYAH SUDAH KO SUSAH-SUSAH EDIT FAIL,";
echo -e "  GUNA MENU NOMBOR 29, UNTUK BUAT FAIL DIGI/MAXIS/CELCOM..MUAH SIKITT..";
sleep 5
echo -e "";
exit 1;
