...
# // Make Config Link
vless_nontls="vless://${uuid}@www.ukm.my.${domain}:${nontls_port}?path=%2Fvless&security=none&encryption=none&host=app.hotlink.com.my&type=ws#${Username}";
vless_tls="vless://${uuid}@www.ukm.my.${domain}:${tls_port}?path=%2Fvless&security=tls&encryption=none&type=ws&sni=app.hotlink.com.my#${Username}";
vless_nontlstv="vless://${uuid}@prod-in.viu.com.${domain}:${nontls_port}?path=%2Fvless&security=none&encryption=none&host=prod-in.viu.com&type=ws#${Username}";
vless_tlstv="vless://${uuid}@prod-in.viu.com.${domain}:${tls_port}?path=%2Fvless&security=tls&encryption=none&type=ws&sni=prod-in.viu.com#${Username}";
...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS HUNT IP TLS 443" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tls}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS HUNT IP NONE TLS 80" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_nontls}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS TV TLS 443" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_tlstv}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG MAXIS TV NONE TLS 80" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e " ${vless_nontlstv}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/kaizenvpn/vless/${Username}/config.log;