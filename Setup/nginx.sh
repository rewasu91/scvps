...
# ═══════════════════════════════════
# // Memasang Nginx Untuk Handle GRPC
# ═══════════════════════════════════
cd /root/;
...
./configure --prefix=/etc/kaizenvpn/webserver/ \
...
wget -q -O /lib/systemd/system/nginx.service "https://raw.githubusercontent.com/rewasu91/scvps/main/Resource/Service/nginx_service";
systemctl stop nginx;
rm -rf /etc/nginx/sites-*;
mkdir -p /etc/nginx/conf.d/;
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/rewasu91/scvps/main/Resource/Config/nginx_conf";
wget -q -O /etc/nginx/conf.d/kaizenvpn.conf "https://raw.githubusercontent.com/rewasu91/scvps/main/Resource/Config/kaizenvpn_conf";
mkdir -p /etc/kaizenvpn/webserver/;
wget -q -O /etc/kaizenvpn/webserver/index.html "https://raw.githubusercontent.com/rewasu91/scvps/main/Resource/Config/index.file";
sudo chown -R www-data:www-data /etc/kaizenvpn/webserver/;
sudo chmod 755 /etc/kaizenvpn/webserver/;
...
# ══════════
clear;
echo -e "${OKEY} Berjaya Memasang Servis Nginx";
